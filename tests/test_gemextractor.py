...
from ritter.dataprocessors.gem_extractor import GemExtractor
...
class GemExtractorTest(unittest.TestCase):
    def test_sentence_reg(self):
        ...
        tokens = ['erik', '18']
        result = GemExtractor._sentence_reg(tokens).findall(sentences)
    ...
    def test_extract_gem(self):
        ...
        result = GemExtractor.extract(text, gem, artifact)
